  ...
  return <section className="c-space section-spacing">
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-default-color grid-1">
            ...
            <div className="z-10">
                <p className="headtext">Hi, I'm Kevin Mung</p>
                <p className="subtext">Starting off as of 17th July 2025, learning React and Vite.js and Tailwindcss and Three.js. Focusing on Front-end Skills to deliver dynamic web applications</p>
            </div>
